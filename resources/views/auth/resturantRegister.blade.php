    ...
    <div class="row ">
        <div class="card col-md-6">
            ...
            <h5 class="card-header info-color white-text text-center py-4">
                <strong><p class="h4 mb-">Sign up as Restaurant Owner</p></strong>
            </h5>

            <div class="form-group">
                <input type="hidden"  name="user_type" class="form-control" value="org" placeholder="Restaurant Owner" readonly>
            </div>
            <div class="form-group">
            <label for=""><b>Name of Your Restaurant</b></label>
                <input type="text"  name="name_of_restaurent" class="form-control" value="{{old('name_of_restaurent')}}" placeholder="Restaurant Name" >
            </div>
            <div class="form-group">
